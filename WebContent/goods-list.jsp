...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
     ...
     <tr>
         ...
         <td>${list.date }</td>
         <td>
         <a href="EditGoodsServlet?do=getEdit&id=${list.num }">修改</a>
         <a href="DeleteGoodsServlet?do=del&id=${list.num}" onclick="javascript:return confirm('确认删除吗？');">删除</a>
         </td>
     </tr>
     </c:forEach>
							</tbody>
